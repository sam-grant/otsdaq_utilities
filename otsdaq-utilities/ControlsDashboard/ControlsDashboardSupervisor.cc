...
//========================================================================================================================
void ControlsDashboardSupervisor::request (const std::string& requestType, cgicc::Cgicc& cgiIn, HttpXmlDocument& xmlOut, const WebUsers::RequestUserInfo& userInfo)
{
	//	__COUT__ << std::endl;
	//	cgicc::Cgicc cgi(in);
	//	__COUT__ << std::endl;
...
//called by constructor
{
	...
	interface_ = makeControls (
	    "ControlsOtsInterface", t /*Key Value*/
	    ,
	    node,
	    nodeName);
	__COUT__ << std::endl;
