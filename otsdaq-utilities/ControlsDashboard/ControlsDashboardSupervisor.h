...
public:
    ...
    XDAQ_INSTANTIATOR();
    						...
    						ControlsDashboardSupervisor     (xdaq::ApplicationStub* s) throw (xdaq::exception::Exception);
    ...
    void GetPVSettings                           (cgicc::Cgicc& cgiIn, HttpXmlDocument& xmlOut, std::string pvList) throw (xgi::exception::Exception);
    void GenerateUID                             (cgicc::Cgicc& cgiIn, HttpXmlDocument& xmlOut, std::string pvlist) throw (xgi::exception::Exception);
