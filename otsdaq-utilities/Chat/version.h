#ifndef _ots_Chat_version_h_
#define _ots_Chat_version_h_
...
namespace Chat
{
const std::string package     = "Chat";
const std::string versions    = MYPACKAGE_FULL_VERSION_LIST;
const std::string summary     = "The Chat Supervisor";
const std::string description = "The Chat Supervisor handles user chatting through the Desktop graphical user interface.";
