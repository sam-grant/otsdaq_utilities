		...
		if( (pDIR=opendir(dirpath.c_str())) )
		{
			...
			while((entry = readdir(pDIR)))
			{
						...
						entry->d_type == 4 || entry->d_type == 8))
				{
					...
					xmlOut.addTextElementToData(isDir?"dir":
							(isNotRtCfg?"dir":"file"),
							entry->d_name);
				}
			}
...
//	catch(...)
//	{
//		__SUP_COUT_INFO__ << "ERROR! Couldn't Halt the VisualSupervisor" << std::endl;
//	}
//}
//
////========================================================================================================================
...
//	catch(...)
//	{
//		__SUP_COUT_INFO__ << "ERROR! Couldn't Start the VisualSupervisor" << std::endl;
//	}
//}
//
////========================================================================================================================
...
//	catch(...)
//	{
//		__SUP_COUT_INFO__ << "ERROR! Couldn't Stop the VisualSupervisor" << std::endl;
//	}
//}
//
//
...
//	catch(...)
//	{
//		__SUP_COUT_INFO__ << "ERROR! Couldn't Pause the VisualSupervisor" << std::endl;
//	}
//}
//
////========================================================================================================================
...
//	catch(...)
//	{
//		__SUP_COUT_INFO__ << "ERROR! Couldn't Resume the VisualSupervisor" << std::endl;
//	}
//}
