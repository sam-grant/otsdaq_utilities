...
Tag_t::
    Tag_t ()
    : ::xml_schema::type (), name_ (this)
{
}

Tag_t::
    Tag_t (const name_type& name)
    : ::xml_schema::type (), name_ (name, this)
{
}
...
Attachment_t::
    Attachment_t ()
    : ::xml_schema::base64_binary (), type_ (this), filename_ (this)
{
}
...
Form_t::
    Form_t ()
    : ::xml_schema::type (), field_ (this), name_ (this)
{
}
...
ECLEntry_t::
    ...
    : ::xml_schema::type (), tag_ (this), attachment_ (this), form_ (this), author_ (author, this), category_ (category, this)
{
}
...
ECLEntry_t::
    ECLEntry_t (const ECLEntry_t&        x,
                ::xml_schema::flags      f,
                ::xml_schema::container* c)
    : ::xml_schema::type (x, f, c), tag_ (x.tag_, f, this), attachment_ (x.attachment_, f, this), form_ (x.form_, f, this), author_ (x.author_, f, this), category_ (x.category_, f, this)
{
}
...
ECLEntry_t::
    ECLEntry_t (const ::xercesc::DOMElement& e,
                ::xml_schema::flags          f,
                ::xml_schema::container*     c)
    : ::xml_schema::type (e, f | ::xml_schema::flags::base, c), tag_ (this), attachment_ (this), form_ (this), author_ (this), category_ (this)
{
	if ((f & ::xml_schema::flags::base) == 0)
	{
		::xsd::cxx::xml::dom::parser<char> p (e, true, false, true);
...
void entry (::xercesc::DOMDocument& d,
            const ::ECLEntry_t&     s,
            ::xml_schema::flags)
{
