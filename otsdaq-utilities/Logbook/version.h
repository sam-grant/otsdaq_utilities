...
const std::string description = "The Logbook Supervisor handles logbook messages from the system and users as well as display through the Desktop graphical user interface.";
