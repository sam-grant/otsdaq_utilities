...
namespace ConfigurationGUI
{
	...
	const std::string description = "The ConfigurationGUI Supervisor handles editing the system configuration tree with support through the Desktop graphical user interface.";
