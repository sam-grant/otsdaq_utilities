#ifndef _ots_MacroMaker_version_h_
#define _ots_MacroMaker_version_h_
...
{
	const std::string package     = "MacroMaker";
	const std::string versions    = MYPACKAGE_FULL_VERSION_LIST;
	const std::string summary     = "The MacroMaker Supervisor";
	const std::string description = "The MacroMaker Supervisor handles low level sequences of read and writes to front-end interfaces with access through the Desktop graphical user interface.";
